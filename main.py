...
# TODO: Scraping the Billboard Hot 100-Using what you've learnt about BeautifulSoup, scrape the top 100 song titles on that date into a Python List
...
# TODO: Using the Spotipy documentation, create a new private playlist with the name "YYYY-MM-DD Billboard 100", where the date is the date you inputted in step 1.
...
# TODO: Add each of the songs found in Step 3 to the new playlist.
